		...
		return (
			<Column>
				...
				<div className='rabin'>
					...
					<img id='rabin2' src={`${mainLink}/rabin-painting.jpg`} alt='Rabin Painting' className={className} data-testid={testId} onMouseOver={()=>this.hoverOn()} onMouseLeave={()=>this.hoverOff()} />
				</div>
