...
const CatPost = () => (
	<Row className='display grid-x cat-post'>
		<Column large={6} offsetOnLarge={3}>
			<img src={`${imageLink}/IMG_6294.JPG`} alt={'View from Shefayim'}/>
			...
			<img src={`${imageLink}/IMG_6296.JPG`} alt={'Shefayim Kibbutz Hotel Courtyard'}/>
			...
			<img src={`${imageLink}/IMG_6302.JPG`} alt={'Shefayim Kibbutz Hotel'}/>
