...
const CatPost = () => (
	<Row className='display grid-x cat-post'>
		<Column large={6} offsetOnLarge={3}>
			<img src={`/assets/IMG_6294.JPG`} alt={'View from Shefayim'}/>
			...
			<img src={`/assets/IMG_6296.JPG`} alt={'Shefayim Kibbutz Hotel Courtyard'}/>
			...
			<img src={`/assets/IMG_6302.JPG`} alt={'Shefayim Kibbutz Hotel'}/>
